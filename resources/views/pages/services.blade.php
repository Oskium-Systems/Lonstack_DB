            ...
            <div class="tf-container">
                <div class="list-services flex flex-wrap">
                    ...
                    <div class="services-item px-lg-15 no-img">
                        <div class="icon">
                            <i class="icon-augmented"></i>
                        </div>

                        <h5 class="lh-30 fw-6"><a href="services-details.html" class="title-service"> Machine
                                Learning</a></h5>

                        <div class="desc lh-30">
                            Machine learning revolutionizing was way businesses operate by system the learn from data and
                            performance
                        </div>
                    ...
                    <div class="services-item px-lg-15 no-img">
                        <div class="icon">
                            <i class="icon-artificial"></i>
                        </div>

                        <h5 class="lh-30 fw-6"><a href="services-details.html" class="title-service">Artificial
                                Intelligence</a></h5>

                        <div class="desc lh-30">
                            Artificial Intelligence is at the forefront technological innovation, transforming industries
                            and driving
                        </div>
                    ...
                    <div class="services-item px-lg-15 no-img">
                        ...
                        <h5 class="lh-30 fw-6"><a href="services-details.html" class="title-service">Augmented
                                Reality</a></h5>

                        <div class="desc lh-30">
                            Augmented Reality is revolutionizing the way interact with digital content by overlaying virtual
                            elements onto
                        </div>
                    ...
                    <div class="services-item px-lg-15 no-img">
                        ...
                        <h5 class="lh-30 fw-6"><a href="services-details.html" class="title-service">Custom Software
                                Development</a></h5>
